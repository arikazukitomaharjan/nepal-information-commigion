...
/*
 * metismenu - v2.0.0 A jQuery menu plugin https://github.com/onokumus/metisMenu
 * 
...
/*
 * AngularJS v1.3.15 (c) 2010-2014 Google, Inc. http://angularjs.org License:
 * MIT
 */
 ...
 * 
 * Version: 0.13.0 - 2015-05-02 License: MIT
 */
...
/*
 * ! Colorbox 1.6.1 license: MIT http://www.jacklmoore.com/colorbox
 */
...
/*
 * ! jQuery UI - v1.11.4 - 2015-03-13 http://jqueryui.com Copyright jQuery
 ...
 * Russel Vela @author Marcus Schwarz <msspamfang@gmx.de>
 * 
...
/*
 * ! jQuery UI - v1.11.1+CommonJS - 2014-09-17 http://jqueryui.com Includes:
 * widget.js Copyright 2014 jQuery Foundation and other contributors; Licensed
 * MIT
 */
                        ...
                        iframe
                            ...
                            .bind('load', function () {
                                ...
                                try {
                                    ...
                                    // exception when calling iframe.contents()
									// on
            ...
            var that = this,
                ...
                send = function () {
                    ...
                    jqXHR = jqXHR || (
                        ...
                        if (that._active === 0) {
                            // The stop callback is triggered when all uploads
							// have
        ...
        _initEventHandlers: function () {
            if (this._isXHRUpload(this.options)) {
                this._on(this.options.dropZone, {
                    ...
                    drop: this._onDrop,
                    // event.preventDefault() on dragenter is required for
					// IE10+:
...
/*
 * ! Respond.js v1.4.2: min/max-width media query polyfill Copyright 2014 Scott
 * Jehl Licensed under MIT http://j.mp/respondjs
 */
...
$('#filesToUpload').bind("change", function(){
...
$('#checkAll').on("click", function(){
	   ...
	   var rowCount = document.getElementById('articles-table').rows;
	   for ( var i = 1; i < rowCount.length; i++) {
			if (checked) {					
				var chek=$(rowCount[i]).find('input:checkbox').eq(0);
...
$('.check').on("click", function(){
	   ...
	   if (checked) {
			...
			var ind = array.indexOf(this.value);
			array.splice(ind, 1);
...
$('#delete-button-articles').on('click',function(){
	
	$.ajax({
		url:'articles_delete/'+array,	
...
$('#menuType').on('change',function(){
	menuTypeValue=this.value;
	if(menuTypeValue == 'Child'){
		$.ajax({
			...
			success: function(response){
			  ...
			  var selectList=document.getElementById("parentMenuType");
